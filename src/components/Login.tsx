...
const Login = ({ isDarkMode, setIsDarkMode }: signProps) => {
    ...
    return (
        ...
        <section className="pt-[85px] md:py-[231px] relative">
            <div className="max-w-[1440px] px-5 mx-auto lg:pl-[179px] flex">
                <div className="max-w-[362px] max-lg:mx-auto z-50">
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="grid grid-cols-1 gap-y-2.5 md:gap-y-4 mb-5">
                            ...
                            {error && (
                                <div className="text-red-500 text-sm mb-3">{error}</div> // Error message display
                            )}
                        ...
                        <p className="mt-4 font-normal text-sm text-[#808191] text-center">
                            Don’t have an account? <span className="font-medium text-[#475BE8] cursor-pointer" onClick={() => navigate("/sign")}>Sign in</span>
                        </p>
                    </form>
                </div>
            </div>
